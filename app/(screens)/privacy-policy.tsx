...
const PrivacyPolicy = () => {
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.listItem}>
        <Text style={styles.bold}>Application</Text> refers to B Online Market Owner, the software program provided by the Company.
      </Text>
      <Text style={styles.listItem}>
      ...
      <Text style={styles.listItem}>Pictures and other information from your Device's camera and photo library</Text>
      <Text>
      ...
      <Text style={styles.listItem}><Text style={styles.bold}>With Service Providers:</Text> We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.</Text>
      <Text style={styles.listItem}><Text style={styles.bold}>For business transfers:</Text> We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.</Text>
      ...
      <Text style={styles.listItem}><Text style={styles.bold}>With business partners:</Text> We may share Your information with Our business partners to offer You certain products, services or promotions.</Text>
      <Text style={styles.listItem}><Text style={styles.bold}>With other users:</Text> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.</Text>
      <Text style={styles.listItem}><Text style={styles.bold}>With Your consent</Text>: We may disclose Your personal information for any other purpose with Your consent.</Text>
      ...
      <Text style={styles.listItem}>By email: help@bonlinemarket.com</Text>
    </ScrollView>
  );
};
